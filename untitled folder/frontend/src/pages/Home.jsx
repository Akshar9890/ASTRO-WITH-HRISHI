...
export default function Home() {
  ...
  return (
    <>
      ...
      <main>
        ...
        <section className={styles.cta}>
          ...
          <div className={styles.ctaBtns}>
            <a href="https://wa.me/919999999999" className="btn-primary" target="_blank" rel="noreferrer">💬 WhatsApp Chat Now</a>
            <a href="tel:+918734955505" className="btn-outline">📞 Call Now</a>
          </div>
        </section>
      </main>
      ...
      {/* Floating buttons */}
      <a href="https://wa.me/919999999999" className={styles.floatWa} target="_blank" rel="noreferrer">💬</a>
      <a href="tel:+919999999999" className={styles.floatCall}>📞</a>
    </>
  );
}
